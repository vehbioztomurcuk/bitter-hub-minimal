...
import bitterLogo from "C:\\Users\\vehbi\\Documents\\gatsby-1\\gatsby-starter-portfolio-minimal\\src\\images\\bitter-atolye-logo.png"
  ...
  return (
    <StyledHeader initial={{ opacity: 0, y: -10 }} animate={controls}>
      ...
      <Link to="/" aria-label="home">
        <img src={bitterLogo} alt="Your Logo Alt Text" style={{ height: '6rem' }} />
      </Link>
        {navigation}
      </StyledContentWrapper>
    </StyledHeader>
